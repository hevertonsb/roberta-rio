...
$(document).ready(function(e) {
	...
	var scrollPosition = $("div.grid-prod-collection").scrollTop();
	localStorage.setItem("scrollPosition", scrollPosition);
	if(localStorage.scrollPosition) {
		$("div.grid-prod-collection").scrollTop(localStorage.getItem("scrollPosition"));
	}

	var scrollPositionPress = $(".press-list").scrollTop();
	localStorage.setItem("scrollPositionPress", scrollPositionPress);
	if(localStorage.scrollPositionPress) {
		$(".press-list").scrollTop(localStorage.getItem("scrollPositionPress"));
	}

	$('#back-press').click(function(e){
		e.preventDefault();
		window.history.back();
		var scrollPositionPress = $(".press-list").scrollTop();
		localStorage.setItem("scrollPositionPress", scrollPositionPress);
	...
	$(".meet-roberta-elevate").elevateZoom({
		zoomType: "lens",
  		lensShape: "round",
  		lensSize: 200
	});
